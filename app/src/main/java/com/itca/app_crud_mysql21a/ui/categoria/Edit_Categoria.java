package com.itca.app_crud_mysql21a.ui.categoria;
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (id.length() == 0){
                    ...
                    String est= String.valueOf(spinner.getSelectedItem());
                    uddate_server(getApplicationContext(), Integer.parseInt(id), nombre, Integer.parseInt(est));
